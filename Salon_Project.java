     ...
     Font f = new Font("TimesRoman", Font.BOLD, 25);
      Font f1 = new Font("TimesRoman", Font.BOLD, 18);
       ...
       public SalonShop(){
          ...
          ImageIcon imgc = new ImageIcon(((new ImageIcon("C:\\Pic\\addcustomerr.png").getImage()
                .getScaledInstance(100, 100, Image.SCALE_SMOOTH))));
        cus_add.setIcon(imgc);
        
        show_bill.setBorder(BorderFactory.createEmptyBorder());
         ImageIcon imgc2 = new ImageIcon(((new ImageIcon("C:\\Pic\\bill.jpeg").getImage()
                .getScaledInstance(100, 100, Image.SCALE_SMOOTH))));
        show_bill.setIcon(imgc2);
        
        history.setBorder(BorderFactory.createEmptyBorder());
          ImageIcon imgc3 = new ImageIcon(((new ImageIcon("C:\\Pic\\His.png").getImage()
                .getScaledInstance(100, 100, Image.SCALE_SMOOTH))));
        history.setIcon(imgc3);
        
        login_back.setBorder(BorderFactory.createEmptyBorder());
          ImageIcon imgc4 = new ImageIcon(((new ImageIcon("C:\\Pic\\llog.png").getImage()
                .getScaledInstance(100, 100, Image.SCALE_SMOOTH))));
